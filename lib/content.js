...
export const META_DESCRIPTION =
  "Joseph Atkinson, Art Director based in London, UK. A full CV and portfolio is available upon request.";

export const DESCRIPTION = ({ onMouseOver, onMouseOut, active }) => (
  <>
    <span className={active && description["description__span--inactive"]}>
      Joseph Atkinson, Art Director based in London, UK.{" "}
    </span>
    <span className={active && description["description__span--inactive"]}>
      A full CV and portfolio is available upon request via{" "}
    </span>
    <Link
...
export const EXPERIENCE = ({ onMouseOver, onMouseOut, active }) => (
  <>
    <span className={active && experience["experience__span--inactive"]}>
      Previously Made Thought, Studio Frith, Zak Group, Droga5 and Boiler Room.
    </span>
  </>
);
